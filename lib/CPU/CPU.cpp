...
void CPU::step() {
    ...
    switch (current) {
        ...
        case OpCode::LD_A_A:
            ...
            break;
        case OpCode::LD_B_n:
            LD_r_n(TargetRegister::B);
            break;
        case OpCode::LD_C_n:
            LD_r_n(TargetRegister::C);
            break;
        case OpCode::LD_D_n:
            LD_r_n(TargetRegister::D);
            break;
        case OpCode::LD_E_n:
            LD_r_n(TargetRegister::E);
            break;
        case OpCode::LD_H_n:
            LD_r_n(TargetRegister::H);
            break;
        case OpCode::LD_L_n:
            LD_r_n(TargetRegister::L);
            break;
        case OpCode::LD_A_n:
            LD_r_n(TargetRegister::A);
            break;
        case OpCode::LD_B_HL:
            LD_r_HL(TargetRegister::B);
            break;
        case OpCode::LD_C_HL:
            LD_r_HL(TargetRegister::C);
            break;
        case OpCode::LD_D_HL:
            LD_r_HL(TargetRegister::D);
            break;
        case OpCode::LD_E_HL:
            LD_r_HL(TargetRegister::E);
            break;
        case OpCode::LD_H_HL:
            LD_r_HL(TargetRegister::H);
            break;
        case OpCode::LD_L_HL:
            LD_r_HL(TargetRegister::L);
            break;
        case OpCode::LD_A_HL:
...
void CPU::LD_r_n(TargetRegister target) {
    load(m_registers.get(target), m_bus.readByte(m_pc++));
}
...
void CPU::LD_A_BC() {
    load(m_registers.a, m_bus.readByte(m_registers.getBC()));
}
